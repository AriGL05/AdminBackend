                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="language_id" name="language_id" required class="form-control select2" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    <label for="category_id">Categoría/Género</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="release_year" name="release_year" placeholder="" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Sobre esta película.."></textarea>
                                </div>
                            </div>
                        </div>
